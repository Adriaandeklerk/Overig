...
var margin = {top:10, right:10, bottom:90, left:10};
             ...
             xScale.domain(data.map(function(d) { return data[id].name; }));
             ...
             var yAxis_g = svgContainer.append("g")
             	...
             	svgContainer.selectAll(".bar")
               		...
               		.attr("x", 190)
               		.attr("width", 100)
               		.attr("y", function(d) { return yScale(data[id].rate); })
               		.attr("height", function(d) { return height - yScale(data[id].rate); });
              ...
              svgContainer.selectAll(".text")
              	  ...
              	  .attr("class","label")
              	  .attr("x", 240)
              	  .attr("y", function(d) { return yScale(data[id].rate) + 1; })
              	  .attr("dy", ".75em")
              	  .text(function(d) { return data[id].rate; });
                };
